        ...
        return (
            <div className='createNewNote'>
                ...
                <form className='newNoteItem' onSubmit={this.createNoteHandler} onClick={this.colorChangeHandler}>
                    <input style={{backgroundColor: this.state.backColor}} ref={this.titleInput}
                           className='newNoteItem-title' type='text' placeholder='Title'/>
                    <textarea style={{backgroundColor: this.state.backColor}} ref={this.textInput}
                              className='newNoteItem-text' type='text' placeholder='Note text'/>
                    ...
                    <button style={{backgroundColor: this.state.backColor}} className='newNoteItem-submit'
                            type='submit'>Create
                    </button>
                </form>
            </div>
